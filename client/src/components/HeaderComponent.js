// Refactored HeaderComponent with conditional nav and auth-based links

import React from 'react';
import { NavLink as RRNavLink } from 'react-router-dom';
import { Navbar, NavbarBrand, Nav, NavItem, NavLink } from 'reactstrap';

const HeaderComponent = ({ auth, logoutUser }) => {
  return (
    <Navbar color="dark" dark expand="md" className="px-3">
      ...
      <Nav className="ms-auto" navbar>
        ...
        <NavItem>
          <NavLink tag={RRNavLink} to="/search" activeClassName="active">
            Search
          </NavLink>
        </NavItem>
        ...
        {auth.isAuthenticated && (
          <>
            <NavItem>
              <NavLink tag={RRNavLink} to="/profile" activeClassName="active">
                Profile
              </NavLink>
            </NavItem>
            <NavItem>
            ...
            <NavItem>
              <NavLink tag={RRNavLink} to="/logout" onClick={logoutUser}>
                Logout
              </NavLink>
            </NavItem>
          </>
