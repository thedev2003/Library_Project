// Refactored ReturnComponent for simplified logic

import React from 'react';
import { useSelector, useDispatch } from 'react-redux';
import { returnIssue } from '../redux/issuesSlice';
...
const ReturnComponent = () => {
  ...
  return (
    <div className="container mt-3">
      <h2 className="heading text-center">Return Books</h2>
      <hr />
        ...
        {issues.map((issue) => (
          <div className="col-md-6 col-12 mb-3" key={issue._id}>
            <div className="border rounded p-3">
              ...
              <button className="btn btn-danger btn-sm" onClick={() => handleReturn(issue._id)}>
                Return Book
              </button>
            </div>
          </div>
