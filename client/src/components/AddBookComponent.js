// Refactored AddBookComponent with cleaner form layout and validation handling
        ...
        <div className="col-md-8 offset-md-2">
          <LocalForm onSubmit={handleSubmit}>
            <Row className="form-group">
              <Label htmlFor="name" md={4}>Book Name</Label>
              <Col md={8}>
            ...
            {/* More fields like author, isbn, copies, etc. (similar format) */}
